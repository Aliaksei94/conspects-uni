...
%\begin{example}
\dot x = 
\begin{cases} \sqrt{x}, & \mbox{if } x \ge 0 \\ 0, & \mbox{else } x<0 \end{cases}, $x_0 = 0$
Solutions x(t) = 
\begin{cases} \frac{1}{4}(t-c)^2, & \mbox{if } t \ge c \ge 0 \\ 0, &\mbox {else} \end{cases}
%\end{example}
